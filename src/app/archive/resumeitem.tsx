...
// import { AnimatePresence, motion, useAnimation, useInView as useInViewFramerMotion } from 'framer-motion';
...
//   // const { ref: resumeItemRef, inView: resumeItemInView } = useInView({
//   //   triggerOnce: true,
//   //   threshold: 0.5,
//   // });
...
// type TResumeItem = {
//     index: number,
//     resumeItemData: TresumeData,
//     handleToggle: (index: number) => void;
//     toggleResumeDetails: boolean;
// }
//  const ResumeItem = forwardRef<HTMLDivElement, TResumeItem>(({index, resumeItemData, handleToggle, toggleResumeDetails}, ref) => {
//     const i = index;
...
//       // highlighting the resume item in view
//   const resumeItemRef = useRef<HTMLLIElement | null>(null);
//   const resumeItemInView = useInViewFramerMotion(resumeItemRef, {
//     once: false,
//   });
//   const resumeItemControls = useAnimation();
//   useEffect(() => {
//     if (resumeItemInView) {
//       resumeItemControls.start('highlightedBackground');
//     }
//   }, [resumeItemInView]);
...
//     ref={resumeItemRef}
//     variants={{
//       defaultBackground: { backgroundColor: 'transparent' },
//       highlightedBackground: { backgroundColor: 'red' },
//     }}
//     initial="defaultBackground"
//     animate={resumeItemControls}
